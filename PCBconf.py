...
softLayers = {
    "eagle": {
        ...
        39: {"side": 1, "mirrorLayer": None, "color": getFromSettings_Color_1('tPlaceKeepoutColor', 4278190335), "description": "Place Keepout, top side", "value": ['int', '%', 50, 0, 100]},
        40: {"side": 0, "mirrorLayer": None, "color": getFromSettings_Color_1('bPlaceKeepoutColor', 65535), "description": "Place Keepout, bottom side", "value": ['int', '%', 50, 0, 100]},
        41: {"side": 1, "mirrorLayer": None, "color": getFromSettings_Color_1('tRouteKeepoutColor', 4278190335), "description": "Route Keepout, top side", "value": ['int', '%', 50, 0, 100]},
        42: {"side": 0, "mirrorLayer": None, "color": getFromSettings_Color_1('bRouteKeepoutColor', 65535), "description": "Route Keepout, bottom side", "value": ['int', '%', 50, 0, 100]},
        43: {"side": -1, "mirrorLayer": None, "color": getFromSettings_Color_1('vRouteKeepoutColor', 255), "description": "Via Keepout", "value": ['int', '%', 50, 0, 100]},
